...
- Implementing REST APIs with Spring MVC
- Optimizing data access with JPA/Hibernate
- Migrating between Spring versions
- Evaluating Java application performance

**Experience Highlights:**
- Led architectural decisions for enterprise Spring Boot applications at Decathlon
- Implemented customer requirements using Spring at Nuxeo
- Developed Java EE applications with Spring Framework
- Technical presentations on Java G1GC and JVM tuning (SFEIR)
...
**Use this skill when:**
- Building full-stack applications with Angular frontend and Spring Boot backend
- Migrating Angular applications (10 → 18)
...
**Skills:** Team Leadership, Technical Mentoring, Architecture Review, Code Review, Knowledge Sharing

**Use this skill when:**
- Leading development teams (6+ developers)
- Mentoring junior developers
- Conducting architecture reviews
- Establishing code quality standards
- Creating training sessions and best practices

**Experience Highlights:**
- Staff Engineer at Decathlon: Led team of 6 developers, reviewed PRs, guided architectural decisions
- Built trusted team through new recruitment process (Technical Lead at Decathlon)
- Shared knowledge during tech sharing sessions at SFEIR
- Evaluated candidates and created technical tests during recruitment
...
**Use this skill when:**
- Analyzing Java application performance
- Tuning JVM parameters (G1GC)
...
### ✅ Activate for these scenarios:
- "I need help designing a Spring Boot microservice architecture"
- "How do I migrate my legacy Java application to modern Spring?"
- "My Java application has performance issues, help optimize it"
- "I need to set up a CI/CD pipeline with Jenkins"
- "How should I structure my Angular + Spring Boot full-stack app?"
...
- Non-Java development (Python, Node.js, Go as primary language)
- Mobile development (iOS, Android native)
- Database administration (without application context)
- Cloud architecture (AWS, GCP, Azure specifics without Java context)
...
- DDD (Domain-Driven Design) with Spring
- Microservices vs Monolithic decision criteria
...
This skill includes access to technical presentations:
- [Java G1GC Presentation](assets/QuarterBack_G1GC.pdf) - JVM garbage collection tuning
- [JVisual VM & Java Mission Control](assets/QuarterBack_VisualVM_Java-Mission-Control.pdf) - JVM monitoring and profiling
...
- [JPA/Hibernate Best Practices](https://hibernate.org/)
- [Angular Documentation](https://angular.io/docs)

## Validation

This skill has been validated against real-world enterprise applications including:
