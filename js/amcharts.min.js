...
b);AmCharts.isReady?isNaN(c)?f.write(a):setTimeout(function(){AmCharts.realWrite(f,a)},c):AmCharts.ready(function(){isNaN(c)?f.write(a):setTimeout(function(){AmCharts.realWrite(f,a)},c)});return f};AmCharts.realWrite=function(a,b){a.write(b)};AmCharts.toBoolean=function(a,b){if(void 0===a)return b;switch(String(a).toLowerCase()){case "true":case "yes":case "1":return!0;case "false":case "no":case "0":case null:return!1;default:return Boolean(a)}};
AmCharts.removeFromArray=function(a,b){var c;if(void 0!=b&&void 0!=a)for(c=a.length-1;0<=c;c--)a[c]==b&&a.splice(c,1)};AmCharts.isInArray=function(a,b){for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1};AmCharts.getDecimals=function(a){var b=0;isNaN(a)||(a=String(a),-1!=a.indexOf("e-")?b=Number(a.split("-")[1]):-1!=a.indexOf(".")&&(b=a.split(".")[1].length));return b};
AmCharts.wrappedText=function(a,b,c,d,e,f,g,h,k){var l=AmCharts.text(a,b,c,d,e,f,g),m="\n";AmCharts.isModern||(m="<br>");if(10<k)return l;if(l){var n=l.getBBox();if(n.width>h){n=Math.ceil(n.width/h);l.remove();for(var l=[],p=0;-1<(index=b.indexOf(" ",p));)l.push(index),p=index+1;Math.round(b.length/2);for(var t,p=0;p<l.length;p+=Math.ceil(l.length/n))t=l[p],b=b.substr(0,t)+m+b.substr(t+1);if(isNaN(t)){if(0==k)for(p=1;p<n;p++)t=Math.round(b.length/n*p),b=b.substr(0,t)+m+b.substr(t);return AmCharts.text(a,
...
AmCharts.AxisBase=AmCharts.Class({construct:function(a){this.createEvents("clickItem","rollOverItem","rollOutItem");this.viY=this.viX=this.y=this.x=this.dy=this.dx=0;this.axisThickness=1;this.axisColor="#000000";this.axisAlpha=1;this.gridCount=this.tickLength=5;this.gridAlpha=.15;this.gridThickness=1;this.gridColor="#000000";this.dashLength=0;this.labelFrequency=1;this.showLastLabel=this.showFirstLabel=!0;this.fillColor="#FFFFFF";this.fillAlpha=0;this.labelsEnabled=!0;this.labelRotation=0;this.autoGridCount=
...
var a=this.axisLine;a&&AmCharts.remove(a.set);AmCharts.remove(this.grid0)}});
...
!this.foundGraphs||Infinity==this.min||-Infinity==this.max)c=!0;else{var k=this.labelFrequency,l=this.showFirstLabel,m=this.showLastLabel,n=1,p=0,t=Math.round((this.max-this.min)/this.step)+1,q;!0===d?(q=Math.log(this.max)*Math.LOG10E-Math.log(this.minReal)*Math.LOG10E,this.stepWidth=this.axisWidth/q,q>this.logGridLimit&&(t=Math.ceil(Math.log(this.max)*Math.LOG10E)+1,p=Math.round(Math.log(this.minReal)*Math.LOG10E),t>this.gridCountR&&(n=Math.ceil(t/this.gridCountR)))):this.stepWidth=this.axisWidth/
(this.max-this.min);var r=0;1>this.step&&-1<this.step&&(r=AmCharts.getDecimals(this.step));this.integersOnly&&(r=0);r>this.maxDecCount&&(r=this.maxDecCount);var y=this.precision;isNaN(y)||(r=y);this.max=AmCharts.roundTo(this.max,this.maxDecCount);this.min=AmCharts.roundTo(this.min,this.maxDecCount);f={};f.precision=r;f.decimalSeparator=a.nf.decimalSeparator;f.thousandsSeparator=a.nf.thousandsSeparator;this.numberFormatter=f;var x,u=this.guides;e=u.length;if(0<e){var w=this.fillAlpha;for(f=this.fillAlpha=
0;f<e;f++){var z=u[f],A=NaN,C=z.above;isNaN(z.toValue)||(A=this.getCoordinate(z.toValue),x=new this.axisItemRenderer(this,A,"",!0,NaN,NaN,z),this.pushAxisItem(x,C));var B=NaN;isNaN(z.value)||(B=this.getCoordinate(z.value),x=new this.axisItemRenderer(this,B,z.label,!0,NaN,(A-B)/2,z),this.pushAxisItem(x,C));isNaN(A-B)||(x=new this.guideFillRenderer(this,B,A,z),this.pushAxisItem(x,C),x=x.graphics(),z.graphics=x,z.balloonText&&this.addEventListeners(x,z))}this.fillAlpha=w}this.exponential=!1;for(f=p;f<
t;f+=n)u=AmCharts.roundTo(this.step*f+this.min,r),-1!=String(u).indexOf("e")&&(this.exponential=!0,String(u).split("e"));this.duration&&(this.maxInterval=AmCharts.getMaxInterval(this.max,this.duration));var r=this.step,G,u=this.minorGridAlpha;this.minorGridEnabled&&(G=this.getMinorGridStep(r,this.stepWidth*r));for(f=p;f<t;f+=n)if(p=r*f+this.min,d&&this.max-this.min>5*this.min&&(p-=this.min),p=AmCharts.roundTo(p,this.maxDecCount+1),!this.integersOnly||Math.round(p)==p)if(isNaN(y)||Number(AmCharts.toFixed(p,
y))==p){!0===d&&(0===p&&(p=this.minReal),q>this.logGridLimit&&(p=Math.pow(10,f)));x=this.formatValue(p,!1,f);Math.round(f/k)!=f/k&&(x=void 0);if(0===f&&!l||f==t-1&&!m)x=" ";e=this.getCoordinate(p);x=new this.axisItemRenderer(this,e,x,void 0,void 0,void 0,void 0,this.boldLabels);this.pushAxisItem(x);if(p==this.baseValue&&"radar"!=a.type){var D,I,z=this.viW,C=this.viH;x=this.viX;w=this.viY;"H"==this.orientation?0<=e&&e<=z+1&&(D=[e,e,e+g],I=[C,0,h]):0<=e&&e<=C+1&&(D=[0,z,z+g],I=[e,e,e+h]);D&&(e=AmCharts.fitToBounds(2*
this.gridAlpha,0,1),e=AmCharts.line(a.container,D,I,this.gridColor,e,1,this.dashLength),e.translate(x,w),this.grid0=e,a.axesSet.push(e),e.toBack(),AmCharts.setCN(a,e,this.bcn+"zero-grid-"+this.id),AmCharts.setCN(a,e,this.bcn+"zero-grid"))}if(!isNaN(G)&&0<u&&f<t-1){x=this.gridAlpha;this.gridAlpha=this.minorGridAlpha;for(e=1;e<r/G;e++)w=this.getCoordinate(p+G*e),w=new this.axisItemRenderer(this,w,"",!1,0,0,!1,!1,0,!0),this.pushAxisItem(w);this.gridAlpha=x}}q=this.baseValue;this.min>this.baseValue&&
this.max>this.baseValue&&(q=this.min);this.min<this.baseValue&&this.max<this.baseValue&&(q=this.max);d&&q<this.minReal&&(q=this.minReal);this.baseCoord=this.getCoordinate(q);q={type:"axisChanged",target:this,chart:a};q.min=d?this.minReal:this.min;q.max=this.max;this.fire("axisChanged",q);this.axisCreated=!0}d=this.axisLine.set;q=this.labelsSet;this.positionTitle();"radar"!=a.type?(a=this.viX,G=this.viY,b.translate(a,G),q.translate(a,G)):d.toFront();!this.visible||c?(b.hide(),d.hide(),q.hide()):(b.show(),
...
this.handleSynchronization)},handleSynchronization:function(a){var b=this.synchronizeWith;a=b.min;var c=b.max,b=b.step,d=this.synchronizationMultiplier;d&&(this.min=a*d,this.max=c*d,this.step=b*d,a=Math.pow(10,Math.floor(Math.log(Math.abs(this.step))*Math.LOG10E)),a=Math.abs(Math.log(Math.abs(a))*Math.LOG10E),this.maxDecCount=Math.round(a),this.draw())}});
AmCharts.RecAxis=AmCharts.Class({construct:function(a){var b=a.chart,c=a.axisThickness,d=a.axisColor,e=a.axisAlpha,f=a.offset,g=a.dx,h=a.dy,k=a.viX,l=a.viY,m=a.viH,n=a.viW,p=b.container;"H"==a.orientation?(d=AmCharts.line(p,[0,n],[0,0],d,e,c),this.axisWidth=a.width,"bottom"==a.position?(h=c/2+f+m+l-1,c=k):(h=-c/2-f+l+h,c=g+k)):(this.axisWidth=a.height,"right"==a.position?(d=AmCharts.line(p,[0,0,-g],[0,m,m-h],d,e,c),h=l+h,c=c/2+f+g+n+k-1):(d=AmCharts.line(p,[0,0],[0,m],d,e,c),h=l,c=-c/2-f+k));d.translate(c,
h);c=b.container.set();c.push(d);b.axesSet.push(c);AmCharts.setCN(b,d,a.bcn+"line");this.axisSet=c;this.set=d}});
AmCharts.RecItem=AmCharts.Class({construct:function(a,b,c,d,e,f,g,h,k,l,m,n){b=Math.round(b);var p=a.chart;this.value=c;void 0==c&&(c="");k||(k=0);void 0==d&&(d=!0);var t=p.fontFamily,q=a.fontSize;void 0==q&&(q=p.fontSize);var r=a.color;void 0==r&&(r=p.color);void 0!==m&&(r=m);var y=a.chart.container,x=y.set();this.set=x;var u=a.axisThickness,w=a.axisColor,z=a.axisAlpha,A=a.tickLength,C=a.gridAlpha,B=a.gridThickness,G=a.gridColor,D=a.dashLength,I=a.fillColor,N=a.fillAlpha,X=a.labelsEnabled;m=a.labelRotation;
var ka=a.counter,P=a.inside,ea=a.labelOffset,Z=a.dx,la=a.dy,Oa=a.orientation,ba=a.position,aa=a.previousCoord,U=a.viH,ra=a.viW,ca=a.offset,da,sa;g?(void 0!=g.id&&(n=p.classNamePrefix+"-guide-"+g.id),X=!0,isNaN(g.tickLength)||(A=g.tickLength),void 0!=g.lineColor&&(G=g.lineColor),void 0!=g.color&&(r=g.color),isNaN(g.lineAlpha)||(C=g.lineAlpha),isNaN(g.dashLength)||(D=g.dashLength),isNaN(g.lineThickness)||(B=g.lineThickness),!0===g.inside&&(P=!0),isNaN(g.labelRotation)||(m=g.labelRotation),isNaN(g.fontSize)||
(q=g.fontSize),g.position&&(ba=g.position),void 0!==g.boldLabel&&(h=g.boldLabel),isNaN(g.labelOffset)||(ea=g.labelOffset)):""===c&&(A=0);var ja="start";e&&(ja="middle");var Q=m*Math.PI/180,V,va,H=0,v=0,ma=0,fa=V=0,Pa=0;"V"==Oa&&(m=0);var Y;X&&(Y=a.autoWrap&&0===m?AmCharts.wrappedText(y,c,r,t,q,ja,h,e,0):AmCharts.text(y,c,r,t,q,ja,h),ja=Y.getBBox(),fa=ja.width,Pa=ja.height);if("H"==Oa){if(0<=b&&b<=ra+1&&(0<A&&0<z&&b+k<=ra+1&&(da=AmCharts.line(y,[b+k,b+k],[0,A],w,z,B),x.push(da)),0<C&&(sa=AmCharts.line(y,
[b,b+Z,b+Z],[U,U+la,la],G,C,B,D),x.push(sa))),v=0,H=b,g&&90==m&&P&&(H-=q),!1===d?(ja="start",v="bottom"==ba?P?v+A:v-A:P?v-A:v+A,H+=3,e&&(H+=e/2-3,ja="middle"),0<m&&(ja="middle")):ja="middle",1==ka&&0<N&&!g&&!l&&aa<ra&&(d=AmCharts.fitToBounds(b,0,ra),aa=AmCharts.fitToBounds(aa,0,ra),V=d-aa,0<V&&(va=AmCharts.rect(y,V,a.height,I,N),va.translate(d-V+Z,la),x.push(va))),"bottom"==ba?(v+=U+q/2+ca,P?(0<m?(v=U-fa/2*Math.sin(Q)-A-3,H+=fa/2*Math.cos(Q)-4+2):0>m?(v=U+fa*Math.sin(Q)-A-3+2,H+=-fa*Math.cos(Q)-Pa*
Math.sin(Q)-4):v-=A+q+3+3,v-=ea):(0<m?(v=U+fa/2*Math.sin(Q)+A+3,H-=fa/2*Math.cos(Q)):0>m?(v=U+A+3-fa/2*Math.sin(Q)+2,H+=fa/2*Math.cos(Q)):v+=A+u+3+3,v+=ea)):(v+=la+q/2-ca,H+=Z,P?(0<m?(v=fa/2*Math.sin(Q)+A+3,H-=fa/2*Math.cos(Q)):v+=A+3,v+=ea):(0<m?(v=-(fa/2)*Math.sin(Q)-A-6,H+=fa/2*Math.cos(Q)):v-=A+q+3+u+3,v-=ea)),"bottom"==ba?V=(P?U-A-1:U+u-1)+ca:(ma=Z,V=(P?la:la-A-u+1)-ca),f&&(H+=f),f=H,0<m&&(f+=fa/2*Math.cos(Q)),Y&&(q=0,P&&(q=fa/2*Math.cos(Q)),f+q>ra+2||0>f))Y.remove(),Y=null}else{0<=b&&b<=U+1&&
(0<A&&0<z&&b+k<=U+1&&(da=AmCharts.line(y,[0,A],[b+k,b+k],w,z,B),x.push(da)),0<C&&(sa=AmCharts.line(y,[0,Z,ra+Z],[b,b+la,b+la],G,C,B,D),x.push(sa)));ja="end";if(!0===P&&"left"==ba||!1===P&&"right"==ba)ja="start";v=b-q/2;1==ka&&0<N&&!g&&!l&&(d=AmCharts.fitToBounds(b,0,U),aa=AmCharts.fitToBounds(aa,0,U),Q=d-aa,va=AmCharts.polygon(y,[0,a.width,a.width,0],[0,0,Q,Q],I,N),va.translate(Z,d-Q+la),x.push(va));v+=q/2;"right"==ba?(H+=Z+ra+ca,v+=la,P?(f||(v-=q/2+3),H=H-(A+4)-ea):(H+=A+4+u,v-=2,H+=ea)):P?(H+=A+
4-ca,f||(v-=q/2+3),g&&(H+=Z,v+=la),H+=ea):(H+=-A-u-4-2-ca,v-=2,H-=ea);da&&("right"==ba?(ma+=Z+ca+ra,V+=la,ma=P?ma-u:ma+u):(ma-=ca,P||(ma-=A+u)));f&&(v+=f);P=-3;"right"==ba&&(P+=la);Y&&(v>U+1||v<P)&&(Y.remove(),Y=null)}da&&(da.translate(ma,V),AmCharts.setCN(p,da,a.bcn+"tick"),AmCharts.setCN(p,da,n,!0),g&&AmCharts.setCN(p,da,"guide"));!1===a.visible&&(da&&da.remove(),Y&&(Y.remove(),Y=null));Y&&(Y.attr({"text-anchor":ja}),Y.translate(H,v),0!==m&&Y.rotate(-m,a.chart.backgroundColor),a.allLabels.push(Y),
this.label=Y,AmCharts.setCN(p,Y,a.bcn+"label"),AmCharts.setCN(p,Y,n,!0),g&&AmCharts.setCN(p,Y,"guide"));sa&&(AmCharts.setCN(p,sa,a.bcn+"grid"),AmCharts.setCN(p,sa,n,!0),g&&AmCharts.setCN(p,sa,"guide"));va&&(AmCharts.setCN(p,va,a.bcn+"fill"),AmCharts.setCN(p,va,n,!0));l?sa&&AmCharts.setCN(p,sa,a.bcn+"grid-minor"):(a.counter=0===ka?1:0,a.previousCoord=b);0===this.set.node.childNodes.length&&this.set.remove()},graphics:function(){return this.set},getLabel:function(){return this.label}});
...
c,a.viH,m,l),g.translate(b-h+e,f));AmCharts.setCN(a.chart,g,"guide-fill");d.id&&AmCharts.setCN(a.chart,g,"guide-fill-"+d.id);this.set=k.set([g])},graphics:function(){return this.set},getLabel:function(){}});
AmCharts.AmChart=AmCharts.Class({construct:function(a){this.theme=a;this.classNamePrefix="amcharts";this.addClassNames=!1;this.version="3.13.1";AmCharts.addChart(this);this.createEvents("dataUpdated","init","rendered","drawn","failed","resized");this.height=this.width="100%";this.dataChanged=!0;this.chartCreated=!1;this.previousWidth=this.previousHeight=0;this.backgroundColor="#FFFFFF";this.borderAlpha=this.backgroundAlpha=0;this.color=this.borderColor="#000000";this.fontFamily="Verdana";this.fontSize=
...
AmCharts.GraphDataItem=AmCharts.Class({construct:function(){}});AmCharts.Guide=AmCharts.Class({construct:function(a){this.cname="Guide";AmCharts.applyTheme(this,a,this.cname)}});
...
e,"graph-"+this.type);AmCharts.setCN(a,e,"graph-"+this.id);this.columnsSet=c;this.columnsArray=[];this.ownColumns=[];this.allBullets=[];this.animationArray=[];(d=this.labelPosition)||(e=this.valueAxis.stackType,d="top","column"==this.type&&(a.rotate&&(d="right"),"100%"==e||"regular"==e)&&(d="middle"),this.labelPosition=d);AmCharts.ifArray(this.data)&&(a=!1,"xy"==b?this.xAxis.axisCreated&&this.yAxis.axisCreated&&(a=!0):this.valueAxis.axisCreated&&(a=!0),!this.hidden&&a&&this.createGraph())},createGraph:function(){var a=
...
m=this.width,n=this.height,p=this.y,t=this.rotate,q=this.columnCount,r=AmCharts.toCoordinate(this.cornerRadiusTop,h/2),y=this.connect,x=[],u=[],w,z,A,C,B=this.chart.graphs.length,G,D=this.dx/this.tcc,I=this.dy/this.tcc,N=f.stackType,X=this.start,ka=this.end,P=this.scrollbar,ea="graph-column-";P&&(ea="scrollbar-graph-column-");var Z=this.categoryAxis,la=this.baseCoord,Oa=this.negativeBase,ba=this.columnIndex,aa=this.lineThickness,U=this.lineAlpha,ra=this.lineColorR,ca=this.dashLength,da=this.set,sa,
ja=this.getGradRotation(),Q=this.chart.columnSpacing,V=Z.cellWidth,va=(V*h-q)/q;Q>va&&(Q=va);var H,v,ma,fa=n+1,Pa=m+1,Y=0,pb=0,qb,rb,db,eb,sb=this.fillColorsR,Ia=this.negativeFillColors,Ba=this.negativeLineColor,Va=this.fillAlphas,Wa=this.negativeFillAlphas;"object"==typeof Va&&(Va=Va[0]);"object"==typeof Wa&&(Wa=Wa[0]);var fb=f.getCoordinate(f.min);f.logarithmic&&(fb=f.getCoordinate(f.minReal));this.minCoord=fb;this.resetBullet&&(this.bullet="none");if(!(P||"line"!=g&&"smoothedLine"!=g&&"step"!=
g||(1==d.length&&"step"!=g&&"none"==this.bullet&&(this.bullet="round",this.resetBullet=!0),!Ia&&void 0==Ba||l))){var Qa=Oa;Qa>f.max&&(Qa=f.max);Qa<f.min&&(Qa=f.min);f.logarithmic&&(Qa=f.minReal);var Fa=f.getCoordinate(Qa),Hb=f.getCoordinate(f.max);t?(fa=n,Pa=Math.abs(Hb-Fa)+1,qb=n,rb=Math.abs(fb-Fa)+1,eb=pb=0,f.reversed?(Y=0,db=Fa):(Y=Fa,db=0)):(Pa=m,fa=Math.abs(Hb-Fa)+1,rb=m,qb=Math.abs(fb-Fa)+1,db=Y=0,f.reversed?(eb=p,pb=Fa):eb=Fa+1)}var Ga=Math.round;this.pmx=Ga(Y);this.pmy=Ga(pb);this.pmh=Ga(fa);
this.pmw=Ga(Pa);this.nmx=Ga(db);this.nmy=Ga(eb);this.nmh=Ga(qb);this.nmw=Ga(rb);AmCharts.isModern||(this.nmy=this.nmx=0,this.nmh=this.height);this.clustered||(q=1);h="column"==g?(V*h-Q*(q-1))/q:V*h;1>h&&(h=1);var Ib=this.fixedColumnWidth;isNaN(Ib)||(h=Ib);var J;if("line"==g||"step"==g||"smoothedLine"==g){if(0<X){for(J=X-1;-1<J;J--)if(H=d[J],v=H.axes[f.id].graphs[b],ma=v.values.value,!isNaN(ma)){X=J;break}if(this.lineColorField)for(J=X;-1<J;J--)if(H=d[J],v=H.axes[f.id].graphs[b],v.lineColor){this.bulletColorSwitched=
this.lineColorSwitched=v.lineColor;break}if(this.fillColorsField)for(J=X;-1<J;J--)if(H=d[J],v=H.axes[f.id].graphs[b],v.fillColors){this.fillColorsSwitched=v.fillColors;break}if(this.dashLengthField)for(J=X;-1<J;J--)if(H=d[J],v=H.axes[f.id].graphs[b],!isNaN(v.dashLength)){this.dashLengthSwitched=v.dashLength;break}}if(ka<d.length-1)for(J=ka+1;J<d.length;J++)if(H=d[J],v=H.axes[f.id].graphs[b],ma=v.values.value,!isNaN(ma)){ka=J;break}}ka<d.length-1&&ka++;var R=[],S=[],Ja=!1;if("line"==g||"step"==g||
"smoothedLine"==g)if(this.stackable&&"regular"==N||"100%"==N||this.fillToGraph)Ja=!0;var Jb=this.noStepRisers,gb=-1E3,hb=-1E3,ib=this.minDistance,Ka=!0,Xa=!1;for(J=X;J<=ka;J++){H=d[J];v=H.axes[f.id].graphs[b];v.index=J;var Ya,La=NaN;if(l&&void 0==this.openField)for(var tb=J+1;tb<d.length&&(!d[tb]||!(Ya=d[J+1].axes[f.id].graphs[b])||!Ya.values||(La=Ya.values.value,isNaN(La)));tb++);var T,O,L,ga,na=NaN,F=NaN,E=NaN,M=NaN,K=NaN,Ma=NaN,Ca=NaN,Na=NaN,Da=NaN,xa=NaN,ya=NaN,ha=NaN,ia=NaN,W=NaN,ub=NaN,vb=NaN,
oa=NaN,pa=void 0,Ha=sb,Ra=Va,za=ra,ta,wa,wb=this.proCandlesticks,jb=this.topRadius,Za=this.pattern;void 0!=v.pattern&&(Za=v.pattern);void 0!=v.color&&(Ha=v.color);v.fillColors&&(Ha=v.fillColors);isNaN(v.alpha)||(Ra=v.alpha);isNaN(v.dashLength)||(ca=v.dashLength);var Aa=v.values;f.recalculateToPercents&&(Aa=v.percents);if(Aa){W=this.stackable&&"none"!=N&&"3d"!=N?Aa.close:Aa.value;if("candlestick"==g||"ohlc"==g)W=Aa.close,vb=Aa.low,Ca=f.getCoordinate(vb),ub=Aa.high,Da=f.getCoordinate(ub);oa=Aa.open;
E=f.getCoordinate(W);isNaN(oa)||(K=f.getCoordinate(oa),l&&(La=oa,oa=K=NaN));l&&(void 0==this.openField?Ya&&(Ya.isNegative=La<W?!0:!1,isNaN(La)&&(v.isNegative=!Ka)):v.isNegative=La>W?!0:!1);if(!P)switch(this.showBalloonAt){case "close":v.y=E;break;case "open":v.y=K;break;case "high":v.y=Da;break;case "low":v.y=Ca}var na=H.x[Z.id],Sa=this.periodSpan-1,qa=Math.floor(V/2)+Math.floor(Sa*V/2),Ea=qa,kb=0;"left"==this.stepDirection&&(kb=(2*V+Sa*V)/2,na-=kb);"center"==this.stepDirection&&(kb=V/2,na-=kb);"start"==
this.pointPosition&&(na-=V/2+Math.floor(Sa*V/2),qa=0,Ea=Math.floor(V)+Math.floor(Sa*V));"end"==this.pointPosition&&(na+=V/2+Math.floor(Sa*V/2),qa=Math.floor(V)+Math.floor(Sa*V),Ea=0);if(Jb){var xb=this.columnWidth;isNaN(xb)||(qa*=xb,Ea*=xb)}P||(v.x=na);-1E5>na&&(na=-1E5);na>m+1E5&&(na=m+1E5);t?(F=E,M=K,K=E=na,isNaN(oa)&&!this.fillToGraph&&(M=la),Ma=Ca,Na=Da):(M=F=na,isNaN(oa)&&!this.fillToGraph&&(K=la));if(!wb&&W<oa||wb&&W<sa)v.isNegative=!0,Ia&&(Ha=Ia),Wa&&(Ra=Wa),void 0!=Ba&&(za=Ba);Xa=!1;isNaN(W)||
(l?W>La?(Ka&&(Xa=!0),Ka=!1):(Ka||(Xa=!0),Ka=!0):v.isNegative=W<Oa?!0:!1,sa=W);switch(g){case "line":if(isNaN(W))y||(this.drawLineGraph(x,u,R,S),x=[],u=[],R=[],S=[]);else{if(Math.abs(F-gb)>=ib||Math.abs(E-hb)>=ib)x.push(F),u.push(E),gb=F,hb=E;xa=F;ya=E;ha=F;ia=E;!Ja||isNaN(K)||isNaN(M)||(R.push(M),S.push(K));if(Xa||void 0!=v.lineColor||void 0!=v.fillColors||!isNaN(v.dashLength))this.drawLineGraph(x,u,R,S),x=[F],u=[E],R=[],S=[],!Ja||isNaN(K)||isNaN(M)||(R.push(M),S.push(K)),l?Ka?(this.lineColorSwitched=
ra,this.fillColorsSwitched=sb):(this.lineColorSwitched=Ba,this.fillColorsSwitched=Ia):(this.lineColorSwitched=v.lineColor,this.fillColorsSwitched=v.fillColors),this.dashLengthSwitched=v.dashLength;v.gap&&(this.drawLineGraph(x,u,R,S),x=[],u=[],R=[],S=[])}break;case "smoothedLine":if(isNaN(W))y||(this.drawSmoothedGraph(x,u,R,S),x=[],u=[],R=[],S=[]);else{if(Math.abs(F-gb)>=ib||Math.abs(E-hb)>=ib)x.push(F),u.push(E),gb=F,hb=E;xa=F;ya=E;ha=F;ia=E;!Ja||isNaN(K)||isNaN(M)||(R.push(M),S.push(K));void 0==
v.lineColor&&void 0==v.fillColors&&isNaN(v.dashLength)||(this.drawSmoothedGraph(x,u,R,S),x=[F],u=[E],R=[],S=[],!Ja||isNaN(K)||isNaN(M)||(R.push(M),S.push(K)),this.lineColorSwitched=v.lineColor,this.fillColorsSwitched=v.fillColors,this.dashLengthSwitched=v.dashLength);v.gap&&(this.drawSmoothedGraph(x,u,R,S),x=[],u=[],R=[],S=[])}break;case "step":if(!isNaN(W)){t?(isNaN(w)||(x.push(w),u.push(E-qa)),u.push(E-qa),x.push(F),u.push(E+Ea),x.push(F),!Ja||isNaN(K)||isNaN(M)||(isNaN(A)||(R.push(A),S.push(K-
qa)),R.push(M),S.push(K-qa),R.push(M),S.push(K+Ea))):(isNaN(z)||(u.push(z),x.push(w),u.push(z),x.push(F-qa)),x.push(F-qa),u.push(E),x.push(F+Ea),u.push(E),!Ja||isNaN(K)||isNaN(M)||(isNaN(C)||(R.push(M-qa),S.push(C)),R.push(M-qa),S.push(K),R.push(M+Ea),S.push(K)));w=F;z=E;A=M;C=K;xa=F;ya=E;ha=F;ia=E;if(Xa||void 0!=v.lineColor||void 0!=v.fillColors||!isNaN(v.dashLength)){var Wb=x[x.length-2],Xb=u[u.length-2];x.pop();u.pop();this.drawLineGraph(x,u,R,S);x=[Wb];u=[Xb];R=[];S=[];this.lineColorSwitched=
v.lineColor;this.fillColorsSwitched=v.fillColors;this.dashLengthSwitched=v.dashLength;l&&(Ka?(this.lineColorSwitched=ra,this.fillColorsSwitched=sb):(this.lineColorSwitched=Ba,this.fillColorsSwitched=Ia))}if(Jb||v.gap)w=z=NaN,this.drawLineGraph(x,u,R,S),x=[],u=[],R=[],S=[]}else if(!y){if(1>=this.periodSpan||1<this.periodSpan&&F-w>qa+Ea)w=z=NaN;this.drawLineGraph(x,u,R,S);x=[];u=[];R=[];S=[]}break;case "column":ta=za;void 0!=v.lineColor&&(ta=v.lineColor);if(!isNaN(W)){l||(v.isNegative=W<Oa?!0:!1);v.isNegative&&
(Ia&&(Ha=Ia),void 0!=Ba&&(ta=Ba));var Kb=f.min,Lb=f.max;if(!(W<Kb&&oa<Kb||W>Lb&&oa>Lb)){var ua;if(t){"3d"==N?(O=E-(q/2-this.depthCount+1)*(h+Q)+Q/2+I*ba,T=M+D*ba,ua=ba):(O=Math.floor(E-(q/2-ba)*(h+Q)+Q/2),T=M,ua=0);L=h;xa=F;ya=O+h/2;isNaN(M)||M>F&&!v.isNegative&&(xa=M);ha=F;ia=O+h/2;O+L>n+ua*I&&(L=n-O+ua*I);O<ua*I&&(L+=O,O=ua*I);ga=F-M;var Yb=T;T=AmCharts.fitToBounds(T,0,m);ga+=Yb-T;ga=AmCharts.fitToBounds(ga,-T,m-T+D*ba);O<n&&0<L&&(pa=new AmCharts.Cuboid(e,ga,L,D-a.d3x,I-a.d3y,Ha,Ra,aa,ta,U,ja,r,
t,ca,Za,jb,ea),v.columnWidth=Math.abs(ga),v.columnHeight=Math.abs(L))}else{"3d"==N?(T=F-(q/2-this.depthCount+1)*(h+Q)+Q/2+D*ba,O=K+I*ba,ua=ba):(T=F-(q/2-ba)*(h+Q)+Q/2,O=K,ua=0);L=h;xa=T+h/2;ya=E;isNaN(K)||K<E&&!v.isNegative&&(ya=K);ha=T+h/2;ia=E;T+L>m+ua*D&&(L=m-T+ua*D);T<ua*D&&(L+=T-ua*D,T=ua*D);ga=E-K;var Zb=O;O=AmCharts.fitToBounds(O,this.dy,n);ga+=Zb-O;ga=AmCharts.fitToBounds(ga,-O+I*ba,n-O);T<m+ba*D&&0<L&&(this.showOnAxis&&(O-=I/2),pa=new AmCharts.Cuboid(e,L,ga,D-a.d3x,I-a.d3y,Ha,Ra,aa,ta,this.lineAlpha,
ja,r,t,ca,Za,jb,ea),v.columnHeight=Math.abs(ga),v.columnWidth=Math.abs(L))}}if(pa&&(wa=pa.set,AmCharts.setCN(a,pa.set,"graph-"+this.type),AmCharts.setCN(a,pa.set,"graph-"+this.id),v.className&&AmCharts.setCN(a,pa.set,v.className,!0),v.columnGraphics=wa,wa.translate(T,O),this.columnsSet.push(wa),(v.url||this.showHandOnHover)&&wa.setAttr("cursor","pointer"),!P)){"none"==N&&(G=t?(this.end+1-J)*B-c:B*J+c);"3d"==N&&(t?(G=(this.end+1-J)*B-c-1E3*this.depthCount,xa+=D*this.columnIndex,ha+=D*this.columnIndex,
v.y+=D*this.columnIndex):(G=(B-c)*(J+1)+1E3*this.depthCount,ya+=I*this.columnIndex,ia+=I*this.columnIndex,v.y+=I*this.columnIndex));if("regular"==N||"100%"==N)G=t?0<Aa.value?(this.end+1-J)*B+c:(this.end+1-J)*B-c:0<Aa.value?B*J+c:B*J-c;this.columnsArray.push({column:pa,depth:G});v.x=t?O+L/2:T+L/2;this.ownColumns.push(pa);this.animateColumns(pa,J,F,M,E,K);this.addListeners(wa,v)}}break;case "candlestick":if(!isNaN(oa)&&!isNaN(W)){var Ta,$a;ta=za;void 0!=v.lineColor&&(ta=v.lineColor);if(t){if(O=E-h/
2,T=M,L=h,O+L>n&&(L=n-O),0>O&&(L+=O,O=0),O<n&&0<L){var yb,zb;W>oa?(yb=[F,Na],zb=[M,Ma]):(yb=[M,Na],zb=[F,Ma]);!isNaN(Na)&&!isNaN(Ma)&&E<n&&0<E&&(Ta=AmCharts.line(e,yb,[E,E],ta,U,aa),$a=AmCharts.line(e,zb,[E,E],ta,U,aa));ga=F-M;pa=new AmCharts.Cuboid(e,ga,L,D,I,Ha,Va,aa,ta,U,ja,r,t,ca,Za,jb,ea)}}else if(T=F-h/2,O=K+aa/2,L=h,T+L>m&&(L=m-T),0>T&&(L+=T,T=0),ga=E-K,T<m&&0<L){wb&&W>=oa&&(Ra=0);var pa=new AmCharts.Cuboid(e,L,ga,D,I,Ha,Ra,aa,ta,U,ja,r,t,ca,Za,jb,ea),Ab,Bb;W>oa?(Ab=[E,Da],Bb=[K,Ca]):(Ab=[K,
Da],Bb=[E,Ca]);!isNaN(Da)&&!isNaN(Ca)&&F<m&&0<F&&(Ta=AmCharts.line(e,[F,F],Ab,ta,U,aa),$a=AmCharts.line(e,[F,F],Bb,ta,U,aa),AmCharts.setCN(a,Ta,this.bcn+"line-high"),v.className&&AmCharts.setCN(a,Ta,v.className,!0),AmCharts.setCN(a,$a,this.bcn+"line-low"),v.className&&AmCharts.setCN(a,$a,v.className,!0))}pa&&(wa=pa.set,v.columnGraphics=wa,da.push(wa),wa.translate(T,O-aa/2),(v.url||this.showHandOnHover)&&wa.setAttr("cursor","pointer"),Ta&&(da.push(Ta),da.push($a)),xa=F,ya=E,t?(ia=E,ha=F,"open"==k&&
(ha=M),"high"==k&&(ha=Na),"low"==k&&(ha=Ma)):(ia=E,"open"==k&&(ia=K),"high"==k&&(ia=Da),"low"==k&&(ia=Ca),ha=F),P||(v.x=t?O+L/2:T+L/2,this.animateColumns(pa,J,F,M,E,K),this.addListeners(wa,v)))}break;case "ohlc":if(!(isNaN(oa)||isNaN(ub)||isNaN(vb)||isNaN(W))){var Mb=e.set();da.push(Mb);W<oa&&(v.isNegative=!0,void 0!=Ba&&(za=Ba));var lb,mb,nb;if(t){var Cb=E-h/2,Cb=AmCharts.fitToBounds(Cb,0,n),Nb=AmCharts.fitToBounds(E,0,n),Db=E+h/2,Db=AmCharts.fitToBounds(Db,0,n);mb=AmCharts.line(e,[M,M],[Cb,Nb],
za,U,aa,ca);0<E&&E<n&&(lb=AmCharts.line(e,[Ma,Na],[E,E],za,U,aa,ca));nb=AmCharts.line(e,[F,F],[Nb,Db],za,U,aa,ca);ia=E;ha=F;"open"==k&&(ha=M);"high"==k&&(ha=Na);"low"==k&&(ha=Ma)}else{var Eb=F-h/2,Eb=AmCharts.fitToBounds(Eb,0,m),Ob=AmCharts.fitToBounds(F,0,m),Fb=F+h/2,Fb=AmCharts.fitToBounds(Fb,0,m);mb=AmCharts.line(e,[Eb,Ob],[K,K],za,U,aa,ca);0<F&&F<m&&(lb=AmCharts.line(e,[F,F],[Ca,Da],za,U,aa,ca));nb=AmCharts.line(e,[Ob,Fb],[E,E],za,U,aa,ca);ia=E;"open"==k&&(ia=K);"high"==k&&(ia=Da);"low"==k&&(ia=
Ca);ha=F}da.push(mb);da.push(lb);da.push(nb);AmCharts.setCN(a,mb,this.bcn+"stroke-open");AmCharts.setCN(a,nb,this.bcn+"stroke-close");AmCharts.setCN(a,lb,this.bcn+"stroke");v.className&&AmCharts.setCN(a,Mb,v.className,!0);xa=F;ya=E}}if(!P&&!isNaN(W)){var Pb=this.hideBulletsCount;if(this.end-this.start<=Pb||0===Pb){var $b=this.createBullet(v,ha,ia,J),Qb=this.labelText;if(Qb){var Gb=this.createLabel(v,ha,ia,Qb);(Gb=this.positionLabel(xa,ya,Gb,$b,L,ga))&&this.allBullets.push(Gb)}if("regular"==N||"100%"==
N){var Rb=f.totalText;if(Rb){var Ua=this.createLabel(v,0,0,Rb,f.totalTextColor);this.allBullets.push(Ua);var Sb=Ua.getBBox(),Tb=Sb.width,Ub=Sb.height,ab,bb,ob=f.totalTextOffset,Vb=f.totals[J];Vb&&Vb.remove();var cb=0;"column"!=g&&(cb=this.bulletSize);t?(bb=E,ab=0>W?F-Tb/2-2-cb-ob:F+Tb/2+3+cb+ob):(ab=F,bb=0>W?E+Ub/2+cb+ob:E-Ub/2-3-cb-ob);Ua.translate(ab,bb);f.totals[J]=Ua;t?(0>bb||bb>n)&&Ua.remove():(0>ab||ab>m)&&Ua.remove()}}}}}}if("line"==g||"step"==g||"smoothedLine"==g)"smoothedLine"==g?this.drawSmoothedGraph(x,
u,R,S):this.drawLineGraph(x,u,R,S),P||this.launchAnimation();this.bulletsHidden&&this.hideBullets();this.customBulletsHidden&&this.hideCustomBullets()},animateColumns:function(a,b,c,d,e,f){var g=this;c=g.chart.startDuration;0<c&&!g.animationPlayed&&(g.seqAn?(a.set.hide(),g.animationArray.push(a),a=setTimeout(function(){g.animate.call(g)},c/(g.end-g.start+1)*(b-g.start)*1E3),g.timeOuts.push(a)):g.animate(a))},createLabel:function(a,b,c,d,e){var f=this.chart,g=a.labelColor;g||(g=this.color);g||(g=f.color);
...
e.set,g=e.chart,h=e.container,k=h.set(),l=h.set();f.push(l);f.push(k);var m=e.lineAlpha,n=e.lineThickness,f=e.fillAlphas,p=e.lineColorR,t=e.negativeLineAlpha;isNaN(t)&&(t=m);var q=e.lineColorSwitched;q&&(p=q);var q=e.fillColorsR,r=e.fillColorsSwitched;r&&(q=r);var y=e.dashLength;(r=e.dashLengthSwitched)&&(y=r);var r=e.negativeLineColor,x=e.negativeFillColors,u=e.negativeFillAlphas,w=e.baseCoord;0!==e.negativeBase&&(w=e.valueAxis.getCoordinate(e.negativeBase));m=AmCharts.line(h,a,b,p,m,n,y,!1,!0);
AmCharts.setCN(g,m,e.bcn+"stroke");k.push(m);k.click(function(a){e.handleGraphEvent(a,"clickGraph")}).mouseover(function(a){e.handleGraphEvent(a,"rollOverGraph")}).mouseout(function(a){e.handleGraphEvent(a,"rollOutGraph")});void 0===r||e.useNegativeColorIfDown||(n=AmCharts.line(h,a,b,r,t,n,y,!1,!0),AmCharts.setCN(g,n,e.bcn+"stroke"),AmCharts.setCN(g,n,e.bcn+"stroke-negative"),l.push(n));if(0<f||0<u)if(n=a.join(";").split(";"),t=b.join(";").split(";"),m=g.type,"serial"==m?0<c.length?(c.reverse(),d.reverse(),
n=a.concat(c),t=b.concat(d)):e.rotate?(t.push(t[t.length-1]),n.push(w),t.push(t[0]),n.push(w),t.push(t[0]),n.push(n[0])):(n.push(n[n.length-1]),t.push(w),n.push(n[0]),t.push(w),n.push(a[0]),t.push(t[0])):"xy"==m&&(b=e.fillToAxis)&&(AmCharts.isString(b)&&(b=g.getValueAxisById(b)),"H"==b.orientation?(w="top"==b.position?0:b.viH,n.push(n[n.length-1]),t.push(w),n.push(n[0]),t.push(w),n.push(a[0]),t.push(t[0])):(w="left"==b.position?0:b.viW,t.push(t[t.length-1]),n.push(w),t.push(t[0]),n.push(w),t.push(t[0]),
n.push(n[0]))),a=e.gradientRotation,0<f&&(b=AmCharts.polygon(h,n,t,q,f,1,"#000",0,a),b.pattern(e.pattern),AmCharts.setCN(g,b,e.bcn+"fill"),k.push(b)),x||void 0!==r)isNaN(u)&&(u=f),x||(x=r),h=AmCharts.polygon(h,n,t,x,u,1,"#000",0,a),AmCharts.setCN(g,h,e.bcn+"fill"),AmCharts.setCN(g,h,e.bcn+"fill-negative"),h.pattern(e.pattern),l.push(h),l.click(function(a){e.handleGraphEvent(a,"clickGraph")}).mouseover(function(a){e.handleGraphEvent(a,"rollOverGraph")}).mouseout(function(a){e.handleGraphEvent(a,"rollOutGraph")});
e.applyMask(l,k)}},applyMask:function(a,b){var c=a.length();"serial"!=this.chart.type||this.scrollbar||(this.positiveClip(b),0<c&&this.negativeClip(a))},drawSmoothedGraph:function(a,b,c,d){if(1<a.length){var e=this.set,f=this.chart,g=this.container,h=g.set(),k=g.set();e.push(k);e.push(h);var l=this.lineAlpha,m=this.lineThickness,e=this.dashLength,n=this.fillAlphas,p=this.lineColorR,t=this.fillColorsR,q=this.negativeLineColor,r=this.negativeFillColors,y=this.negativeFillAlphas,x=this.baseCoord,u=this.lineColorSwitched;
u&&(p=u);(u=this.fillColorsSwitched)&&(t=u);u=this.negativeLineAlpha;isNaN(u)&&(u=l);l=new AmCharts.Bezier(g,a,b,p,l,m,t,0,e);AmCharts.setCN(f,l,this.bcn+"stroke");h.push(l.path);void 0!==q&&(m=new AmCharts.Bezier(g,a,b,q,u,m,t,0,e),AmCharts.setCN(f,m,this.bcn+"stroke"),AmCharts.setCN(f,m,this.bcn+"stroke-negative"),k.push(m.path));0<n&&(l=a.join(";").split(";"),p=b.join(";").split(";"),m="",0<c.length?(c.push("M"),d.push("M"),c.reverse(),d.reverse(),l=a.concat(c),p=b.concat(d)):(this.rotate?(m+=
" L"+x+","+b[b.length-1],m+=" L"+x+","+b[0]):(m+=" L"+a[a.length-1]+","+x,m+=" L"+a[0]+","+x),m+=" L"+a[0]+","+b[0]),c=new AmCharts.Bezier(g,l,p,NaN,0,0,t,n,e,m),AmCharts.setCN(f,c,this.bcn+"fill"),c.path.pattern(this.pattern),h.push(c.path),r||void 0!==q)&&(y||(y=n),r||(r=q),a=new AmCharts.Bezier(g,a,b,NaN,0,0,r,y,e,m),a.path.pattern(this.pattern),AmCharts.setCN(f,a,this.bcn+"fill"),AmCharts.setCN(f,a,this.bcn+"fill-negative"),k.push(a.path));this.applyMask(k,h)}},launchAnimation:function(){var a=
...
k=g;this.bulletAxis&&(g=a.values.error,isNaN(g)||(h=g),g=this.bulletAxis.stepWidth*h);g<this.minBulletSize&&(g=this.minBulletSize);this.rotate?b=a.isNegative?b-f:b+f:c=a.isNegative?c+f:c-f;var p,n=this.bulletColorR;a.lineColor&&(this.bulletColorSwitched=a.lineColor);this.bulletColorSwitched&&(n=this.bulletColorSwitched);a.isNegative&&void 0!==this.bulletColorNegative&&(n=this.bulletColorNegative);void 0!==a.color&&(n=a.color);var t;"xy"==d.type&&this.valueField&&(t=this.pattern,a.pattern&&(t=a.pattern));
f=this.bullet;a.bullet&&(f=a.bullet);var h=this.bulletBorderThickness,l=this.bulletBorderColorR,m=this.bulletBorderAlpha,q=this.bulletAlpha;l||(l=n);this.useLineColorForBulletBorder&&(l=this.lineColorR);var r=a.alpha;isNaN(r)||(q=r);if("none"!=this.bullet||a.bullet)p=AmCharts.bullet(e,f,g,n,q,h,l,m,k,0,t);if(this.customBullet||a.customBullet)t=this.customBullet,a.customBullet&&(t=a.customBullet),t&&(p&&p.remove(),"function"==typeof t?(p=new t,p.chart=d,a.bulletConfig&&(p.availableSpace=c,p.graph=
this,p.graphDataItem=a,p.bulletY=c,a.bulletConfig.minCoord=this.minCoord-c,p.bulletConfig=a.bulletConfig),p.write(e),p=p.set):(d.path&&(t=d.path+t),p=e.set(),e=e.image(t,0,0,g,g),p.push(e),this.centerCustomBullets&&e.translate(-g/2,-g/2)));p&&((a.url||this.showHandOnHover)&&p.setAttr("cursor","pointer"),"serial"==d.type&&(0>b-0||b-0>this.width||c<-g/2||c-0>this.height)&&(p.remove(),p=null),p&&(this.bulletSet.push(p),p.translate(b,c),this.addListeners(p,a),this.allBullets.push(p)),a.bx=b,a.by=c,AmCharts.setCN(d,
...
a)}}(b=this.bulletSet)&&b.setAttr("opacity",a)},destroy:function(){AmCharts.remove(this.set);AmCharts.remove(this.bulletSet);var a=this.timeOuts;if(a){var b;for(b=0;b<a.length;b++)clearTimeout(a[b])}this.timeOuts=[]}});
...
n=this.width,p=this.height,t=this.data[a];this.fireMoved();if(t){var q=t.x[g.id],r=c.rotate,y=this.stepWidth,x=this.categoryBalloon,u=this.firstTime,w=this.lastTime,z=this.cursorPosition,A=this.zooming,C=this.panning,B=c.graphs;if(c.mouseIsOver||A||C||this.forceShow)if(this.forceShow=!1,C){var h=this.panClickPos,c=this.panClickEndTime,A=this.panClickStartTime,G=this.panClickEnd,l=this.panClickStart,e=(r?h-f:h-e)/y;if(!g.parseDates||g.equalSpacing)e=Math.round(e);0!==e&&(h={type:"zoomed",target:this},
h.chart=this.chart,g.parseDates&&!g.equalSpacing?(c+e>w&&(e=w-c),A+e<u&&(e=u-A),h.start=Math.round(A+e),h.end=Math.round(c+e),this.fire(h.type,h)):G+e>=this.data.length||0>l+e||(h.start=l+e,h.end=G+e,this.fire(h.type,h)))}else{"start"==z?q-=g.cellWidth/2:"mouse"==z&&(c.mouseIsOver?q=r?f-2:e-2:isNaN(this.tempPosition)||(q=this.tempPosition-2));if(r){if(0>q)if(A)q=0;else{this.hideCursor();return}if(q>p+1)if(A)q=p+1;else{this.hideCursor();return}}else{if(0>q)if(A)q=0;else{this.hideCursor();return}if(q>
n)if(A)q=n;else{this.hideCursor();return}}if(0<this.cursorAlpha){var D=this.line;r?(u=0,w=q+k,d&&(w-=g.cellWidth/2)):(u=q,w=0,d&&(u-=g.cellWidth/2));y=this.animationDuration;0<y&&!this.zooming?isNaN(this.previousX)?D.translate(u,w):(D.translate(this.previousX,this.previousY),D.animate({translate:u+","+w},y,"easeOutSine")):D.translate(u,w);this.previousX=u;this.previousY=w;D.show()}this.linePos=r?q+k:q;A&&(d&&D.hide(),r?this.updateSelectionSize(NaN,q):this.updateSelectionSize(q,NaN));y=!0;A&&(y=!1);
this.categoryBalloonEnabled&&y?(this.setBalloonPosition(x,g,q,r),(u=this.categoryBalloonFunction)?x.showBalloon(u(t.category)):g.parseDates?(g=AmCharts.formatDate(t.category,this.categoryBalloonDateFormat,c),-1!=g.indexOf("fff")&&(g=AmCharts.formatMilliseconds(g,t.category)),x.showBalloon(g)):x.showBalloon(AmCharts.fixNewLines(t.category))):x.hide();B&&this.bulletsEnabled&&this.showBullets();if(this.oneBalloonOnly){q=Infinity;for(g=0;g<B.length;g++)u=B[g],u.showBalloon&&!u.hidden&&u.balloonText&&
(w=t.axes[u.valueAxis.id].graphs[u.id],x=w.y,isNaN(x)||(r?Math.abs(e-x)<q&&(q=Math.abs(e-x),G=u):Math.abs(f-x)<q&&(q=Math.abs(f-x),G=u)));this.mostCloseGraph&&(G=this.mostCloseGraph)}if(a!=this.previousIndex||G!=this.previousMostCloseGraph)if(this.normalizeBulletSize(),this.destroyValueBalloons(),this.resizedBullets=[],B&&this.valueBalloonsEnabled&&y&&c.balloon.enabled){this.valueBalloons=y=[];for(g=0;g<B.length;g++)if(u=B[g],x=NaN,(!this.oneBalloonOnly||u==G)&&u.showBalloon&&!u.hidden&&u.balloonText&&
("step"==u.type&&"left"==u.stepDirection&&(t=this.data[a+1]),t)){if(w=t.axes[u.valueAxis.id].graphs[u.id])x=w.y;if(this.showNextAvailable&&isNaN(x)&&a+1<this.data.length)for(q=a+1;q<this.data.length;q++)if(d=this.data[q])if(w=d.axes[u.valueAxis.id].graphs[u.id],x=w.y,!isNaN(x))break;if(!isNaN(x)){d=w.x;k=!0;if(r){if(q=x,0>d||d>p)k=!1}else if(q=d,d=x,0>q||q>n+h+1)k=!1;k&&(k=this.graphBulletSize,D=this.graphBulletAlpha,1==k&&isNaN(D)||!AmCharts.isModern||!(z=w.bulletGraphics)||(z.getBBox(),z.translate(w.bx,
w.by,k),this.resizedBullets.push(w),isNaN(D)||(z.setAttr("fill-opacity",D),z.setAttr("stroke-opacity",D))),k=u.valueBalloon,D=c.getBalloonColor(u,w),k.setBounds(l,m,l+n,m+p),k.pointerOrientation="H",z=this.balloonPointerOrientation,"vertical"==z&&(k.pointerOrientation="V"),"horizontal"==z&&(k.pointerOrientation="H"),k.changeColor(D),void 0!==u.balloonAlpha&&(k.fillAlpha=u.balloonAlpha),void 0!==u.balloonTextColor&&(k.color=u.balloonTextColor),k.setPosition(q+l,d+m),q=c.formatString(u.balloonText,
w,!0),(d=u.balloonFunction)&&(q=d(w,u).toString()),""!==q&&(r?k.showBalloon(q):(k.text=q,k.show=!0),y.push({yy:x,balloon:k})),!r&&k.set&&(k.set.hide(),u=k.textDiv)&&(u.style.visibility="hidden"))}}this.avoidBalloonOverlapping&&this.arrangeBalloons()}b?(h={type:"changed"},h.index=a,h.chart=this.chart,h.zooming=A,h.mostCloseGraph=G,h.position=r?f:e,h.target=this,c.fire("changed",h),this.fire("changed",h),this.skipZoomDispatch=!1):(this.skipZoomDispatch=!0,c.updateLegendValues(a));this.previousIndex=
a;this.previousMostCloseGraph=G}}}else this.hideCursor()},setBalloonPosition:function(a,b,c,d){var e=b.position,f=b.inside;b=b.axisThickness;var g=this.chart,h=g.dx,g=g.dy,k=this.x,l=this.y,m=this.width,n=this.height;d?(f&&("right"==e?a.setBounds(k,l+g,k+m+h,l+c+g):a.setBounds(k,l+g,k+m+h,l+c)),"right"==e?f?a.setPosition(k+m+h,l+c+g):a.setPosition(k+m+h+b,l+c+g):f?a.setPosition(k,l+c):a.setPosition(k-b,l+c)):"top"==e?f?a.setPosition(k+c+h,l+g):a.setPosition(k+c+h,l+g-b+1):f?a.setPosition(k+c,l+n):
...
this.showDragIcons()},handleMouseOut:function(){this.mouseIsOver=!1;this.hideDragIcons()}});
AmCharts.ChartScrollbar=AmCharts.Class({inherits:AmCharts.SimpleChartScrollbar,construct:function(a){this.cname="ChartScrollbar";AmCharts.ChartScrollbar.base.construct.call(this,a);this.enabled=!0;this.graphLineColor="#BBBBBB";this.graphLineAlpha=0;this.graphFillColor="#BBBBBB";this.graphFillAlpha=1;this.selectedGraphLineColor="#888888";this.selectedGraphLineAlpha=0;this.selectedGraphFillColor="#888888";this.selectedGraphFillAlpha=1;this.gridCount=0;this.gridColor="#FFFFFF";this.gridAlpha=.7;this.skipEvent=
...
n.logarithmic=p.logarithmic;n.gridAlpha=0;n.axisAlpha=0;m.push(n.set);e?(n.y=g,n.x=0):(n.x=f,n.y=0);var f=Infinity,g=-Infinity,t;for(t=0;t<c.length;t++){var q=c[t].axes[p.id].graphs[l.id].values,r;for(r in q)if(q.hasOwnProperty(r)&&"percents"!=r&&"total"!=r){var y=q[r];y<f&&(f=y);y>g&&(g=y)}}Infinity!=f&&(n.minimum=f);-Infinity!=g&&(n.maximum=g+.1*(g-f));f==g&&(--n.minimum,n.maximum+=1);void 0!==a.minimum&&(n.minimum=a.minimum);void 0!==a.maximum&&(n.maximum=a.maximum);n.zoom(0,c.length-1);r=a.unselectedGraph;
r.id=l.id;r.bcn="scrollbar-graph-";r.rotate=e;r.chart=b;r.data=c;r.valueAxis=n;r.chart=l.chart;r.categoryAxis=a.categoryAxis;r.periodSpan=l.periodSpan;r.valueField=l.valueField;r.openField=l.openField;r.closeField=l.closeField;r.highField=l.highField;r.lowField=l.lowField;r.lineAlpha=a.graphLineAlpha;r.lineColorR=a.graphLineColor;r.fillAlphas=a.graphFillAlpha;r.fillColorsR=a.graphFillColor;r.connect=l.connect;r.hidden=l.hidden;r.width=h;r.height=k;r.pointPosition=l.pointPosition;r.stepDirection=l.stepDirection;
r.periodSpan=l.periodSpan;p=a.selectedGraph;p.id=l.id;p.bcn=r.bcn+"selected-";p.rotate=e;p.chart=b;p.data=c;p.valueAxis=n;p.chart=l.chart;p.categoryAxis=d;p.periodSpan=l.periodSpan;p.valueField=l.valueField;p.openField=l.openField;p.closeField=l.closeField;p.highField=l.highField;p.lowField=l.lowField;p.lineAlpha=a.selectedGraphLineAlpha;p.lineColorR=a.selectedGraphLineColor;p.fillAlphas=a.selectedGraphFillAlpha;p.fillColorsR=a.selectedGraphFillColor;p.connect=l.connect;p.hidden=l.hidden;p.width=
h;p.height=k;p.pointPosition=l.pointPosition;p.stepDirection=l.stepDirection;p.periodSpan=l.periodSpan;(b=a.graphType)||(b=l.type);r.type=b;p.type=b;c=c.length-1;r.zoom(0,c);p.zoom(0,c);p.set.click(function(){a.handleBackgroundClick()}).mouseover(function(){a.handleMouseOver()}).mouseout(function(){a.handleMouseOut()});r.set.click(function(){a.handleBackgroundClick()}).mouseover(function(){a.handleMouseOver()}).mouseout(function(){a.handleMouseOut()});m.push(r.set);m.push(p.set)}m.push(d.set);m.push(d.labelsSet);
...
this.difference=this.end-this.start;this.timeDifference=this.endTime-this.startTime;0>this.timeDifference&&(this.timeDifference=0)},handleBackgroundClick:function(){AmCharts.ChartScrollbar.base.handleBackgroundClick.call(this);this.dragging||(this.difference=this.end-this.start,this.timeDifference=this.endTime-this.startTime,0>this.timeDifference&&(this.timeDifference=0))}});
AmCharts.AmBalloon=AmCharts.Class({construct:function(a){this.cname="AmBalloon";this.enabled=!0;this.fillColor="#FFFFFF";this.fillAlpha=.8;this.borderThickness=2;this.borderColor="#FFFFFF";this.borderAlpha=1;this.cornerRadius=0;this.maxWidth=220;this.horizontalPadding=8;this.verticalPadding=4;this.pointerWidth=6;this.pointerOrientation="V";this.color="#000000";this.adjustBorderColor=!0;this.show=this.follow=this.showBullet=!1;this.bulletSize=3;this.shadowAlpha=.4;this.shadowColor="#000000";this.fadeOutDuration=
this.animationDuration=.3;this.fixedPosition=!1;this.offsetY=6;this.offsetX=1;this.textAlign="center";AmCharts.isModern||(this.offsetY*=1.5);AmCharts.applyTheme(this,a,this.cname)},draw:function(){var a=this.pointToX,b=this.pointToY;this.deltaSignX=this.deltaSignY=1;var c=this.chart;AmCharts.VML&&(this.fadeOutDuration=0);this.xAnim&&c.stopAnim(this.xAnim);this.yAnim&&c.stopAnim(this.yAnim);if(!isNaN(a)){var d=this.follow,e=c.container,f=this.set;AmCharts.remove(f);this.removeDiv();f=e.set();f.node.style.pointerEvents=
"none";this.set=f;c.balloonsSet.push(f);if(this.show){var g=this.l,h=this.t,k=this.r,l=this.b,m=this.balloonColor,n=this.fillColor,p=this.borderColor,t=n;void 0!=m&&(this.adjustBorderColor?t=p=m:n=m);var q=this.horizontalPadding,r=this.verticalPadding,y=this.pointerWidth,x=this.pointerOrientation,u=this.cornerRadius,w=c.fontFamily,z=this.fontSize;void 0==z&&(z=c.fontSize);var m=document.createElement("div"),A=c.classNamePrefix;m.className=A+"-balloon-div";this.className&&(m.className=m.className+
" "+A+"-balloon-div-"+this.className);A=m.style;A.pointerEvents="none";A.position="absolute";var C=this.minWidth,B="";isNaN(C)||(B="min-width:"+(C-2*q)+"px; ");m.innerHTML='<div style="text-align:'+this.textAlign+"; "+B+"max-width:"+this.maxWidth+"px; font-size:"+z+"px; color:"+this.color+"; font-family:"+w+'">'+this.text+"</div>";c.chartDiv.appendChild(m);this.textDiv=m;z=m.offsetWidth;w=m.offsetHeight;m.clientHeight&&(z=m.clientWidth,w=m.clientHeight);w+=2*r;B=z+2*q;!isNaN(C)&&B<C&&(B=C);window.opera&&
(w+=2);var G=!1,z=this.offsetY;c.handDrawn&&(z+=c.handDrawScatter+2);"H"!=x?(C=a-B/2,b<h+w+10&&"down"!=x?(G=!0,d&&(b+=z),z=b+y,this.deltaSignY=-1):(d&&(b-=z),z=b-w-y,this.deltaSignY=1)):(2*y>w&&(y=w/2),z=b-w/2,a<g+(k-g)/2?(C=a+y,this.deltaSignX=-1):(C=a-B-y,this.deltaSignX=1));z+w>=l&&(z=l-w);z<h&&(z=h);C<g&&(C=g);C+B>k&&(C=k-B);var h=z+r,l=C+q,r=this.shadowAlpha,D=this.shadowColor,q=this.borderThickness,I=this.bulletSize,N;0<u||0===y?(0<r&&(a=AmCharts.rect(e,B,w,n,0,q+1,D,r,this.cornerRadius),AmCharts.isModern?
a.translate(1,1):a.translate(4,4),f.push(a)),n=AmCharts.rect(e,B,w,n,this.fillAlpha,q,p,this.borderAlpha,this.cornerRadius),this.showBullet&&(N=AmCharts.circle(e,I,t,this.fillAlpha),f.push(N))):("H"!=x?(g=a-C,g>B-y&&(g=B-y),g<y&&(g=y),t=[0,g-y,a-C,g+y,B,B,0,0],u=G?[0,0,b-z,0,0,w,w,0]:[w,w,b-z,w,w,0,0,w]):(t=b-z,t>w-y&&(t=w-y),t<y&&(t=y),u=[0,t-y,b-z,t+y,w,w,0,0],t=a<g+(k-g)/2?[0,0,C<a?0:a-C,0,0,B,B,0]:[B,B,C+B>a?B:a-C,B,B,0,0,B]),0<r&&(a=AmCharts.polygon(e,t,u,n,0,q,D,r),a.translate(1,1),f.push(a)),
n=AmCharts.polygon(e,t,u,n,this.fillAlpha,q,p,this.borderAlpha));this.bg=n;f.push(n);n.toFront();AmCharts.setCN(c,n,"balloon-bg");this.className&&AmCharts.setCN(c,n,"balloon-bg-"+this.className);e=1*this.deltaSignX;A.left=l+"px";A.top=h+"px";f.translate(C-e,z);n=n.getBBox();this.bottom=z+w+1;this.yPos=n.y+z;N&&N.translate(this.pointToX-C+e,b-z);b=this.animationDuration;0<this.animationDuration&&!d&&!isNaN(this.prevX)&&(f.translate(this.prevX,this.prevY),f.animate({translate:C-e+","+z},b,"easeOutSine"),
m&&(A.left=this.prevTX+"px",A.top=this.prevTY+"px",this.xAnim=c.animate({node:m},"left",this.prevTX,l,b,"easeOutSine","px"),this.yAnim=c.animate({node:m},"top",this.prevTY,h,b,"easeOutSine","px")));this.prevX=C-e;this.prevY=z;this.prevTX=l;this.prevTY=h}}},followMouse:function(){if(this.follow&&this.show){var a=this.chart.mouseX-this.offsetX*this.deltaSignX,b=this.chart.mouseY;this.pointToX=a;this.pointToY=b;if(a!=this.previousX||b!=this.previousY)if(this.previousX=a,this.previousY=b,0===this.cornerRadius)this.draw();
...
a=this.chart;this.fadeAnim1&&a.stopAnim(this.fadeAnim1);this.fadeAnim2&&a.stopAnim(this.fadeAnim2);this.draw()},hide:function(){var a=this,b=a.fadeOutDuration,c=a.chart;if(0<b){a.destroyTO=setTimeout(function(){a.destroy.call(a)},1E3*b);a.follow=!1;a.show=!1;var d=a.set;d&&(d.setAttr("opacity",a.fillAlpha),a.fadeAnim1=d.animate({opacity:0},b,"easeInSine"));a.textDiv&&(a.fadeAnim2=c.animate({node:a.textDiv},"opacity",1,0,b,"easeInSine",""))}else a.show=!1,a.follow=!1,a.destroy()},setPosition:function(a,
b,c){this.pointToX=a;this.pointToY=b;c&&(a==this.previousX&&b==this.previousY||this.draw());this.previousX=a;this.previousY=b},followCursor:function(a){var b=this;(b.follow=a)?(b.pShowBullet=b.showBullet,b.showBullet=!1):void 0!==b.pShowBullet&&(b.showBullet=b.pShowBullet);clearInterval(b.interval);var c=b.chart.mouseX,d=b.chart.mouseY;!isNaN(c)&&a&&(b.pointToX=c-b.offsetX*b.deltaSignX,b.pointToY=d,b.followMouse(),b.interval=setInterval(function(){b.followMouse.call(b)},40))},removeDiv:function(){if(this.textDiv){var a=
this.textDiv.parentNode;a&&a.removeChild(this.textDiv)}},destroy:function(){clearInterval(this.interval);AmCharts.remove(this.set);this.removeDiv();this.set=null}});
AmCharts.AmCoordinateChart=AmCharts.Class({inherits:AmCharts.AmChart,construct:function(a){AmCharts.AmCoordinateChart.base.construct.call(this,a);this.theme=a;this.createEvents("rollOverGraphItem","rollOutGraphItem","clickGraphItem","doubleClickGraphItem","rightClickGraphItem","clickGraph","rollOverGraph","rollOutGraph");this.startAlpha=1;this.startDuration=0;this.startEffect="elastic";this.sequencedAnimation=!0;this.colors="#FF6600 #FCD202 #B0DE09 #0D8ECF #2A0CD0 #CD0D74 #CC0000 #00CC00 #0000CC #DDDDDD #999999 #333333 #990000".split(" ");
...
this.gridSet.toFront()},createValueAxes:function(){if(0===this.valueAxes.length){var a=new AmCharts.ValueAxis;this.addValueAxis(a)}},parseData:function(){this.processValueAxes();this.processGraphs()},parseSerialData:function(){var a=this.graphs,b,c={},d=this.seriesIdField;d||(d=this.categoryField);this.chartData=[];var e=this.dataProvider;if(e){var f=!1,g,h=this.categoryAxis,k,l,m;h&&(f=h.parseDates,k=h.forceShowField,m=h.classNameField,l=h.labelColorField,g=h.categoryFunction);var n,p,t={},q;f&&
(b=AmCharts.extractPeriod(h.minPeriod),n=b.period,p=b.count,q=AmCharts.getPeriodDuration(n,p));var r={};this.lookupTable=r;var y,x=this.dataDateFormat,u={};for(y=0;y<e.length;y++){var w={},z=e[y];b=z[this.categoryField];w.dataContext=z;w.category=g?g(b,z,h):String(b);k&&(w.forceShow=z[k]);m&&(w.className=z[m]);l&&(w.labelColor=z[l]);r[z[d]]=w;if(!f||(b=h.categoryFunction?h.categoryFunction(b,z,h):b instanceof Date?AmCharts.newDate(b,h.minPeriod):x?AmCharts.stringToDate(b,x):new Date(b),b=AmCharts.resetDateToMin(b,
n,p,h.firstDayOfWeek),w.category=b,w.time=b.getTime(),!isNaN(w.time))){var A=this.valueAxes;w.axes={};w.x={};var C;for(C=0;C<A.length;C++){var B=A[C].id;w.axes[B]={};w.axes[B].graphs={};var G;for(G=0;G<a.length;G++){b=a[G];var D=b.id,I=1.1;isNaN(b.gapPeriod)||(I=b.gapPeriod);var N=b.periodValue;if(b.valueAxis.id==B){w.axes[B].graphs[D]={};var X={};X.index=y;var ka=z;b.dataProvider&&(ka=c);X.values=this.processValues(ka,b,N);!b.connect&&u&&u[D]&&w.time-t[D]>=q*I&&(u[D].gap=!0);this.processFields(b,
X,ka);X.category=w.category;X.serialDataItem=w;X.graph=b;w.axes[B].graphs[D]=X;t[D]=w.time;u[D]=X}}}this.chartData[y]=w}}}for(c=0;c<a.length;c++)b=a[c],b.dataProvider&&this.parseGraphData(b)},processValues:function(a,b,c){var d={},e,f=!1;"candlestick"!=b.type&&"ohlc"!=b.type||""===c||(f=!0);e=Number(a[b.valueField+c]);isNaN(e)||(d.value=e);e=Number(a[b.errorField+c]);isNaN(e)||(d.error=e);f&&(c="Open");e=Number(a[b.openField+c]);isNaN(e)||(d.open=e);f&&(c="Close");e=Number(a[b.closeField+c]);isNaN(e)||
...
c.valueAxis||(c.valueAxis=this.valueAxes[0]);c.id||(c.id="graphAuto"+b+"_"+(new Date).getTime())}},formatString:function(a,b,c){var d=b.graph,e=d.valueAxis;e.duration&&b.values.value&&(e=AmCharts.formatDuration(b.values.value,e.duration,"",e.durationUnits,e.maxInterval,e.numberFormatter),a=a.split("[[value]]").join(e));a=AmCharts.massReplace(a,{"[[title]]":d.title,"[[description]]":b.description});a=c?AmCharts.fixNewLines(a):AmCharts.fixBrakes(a);return AmCharts.cleanFromEmpty(a)},getBalloonColor:function(a,
...
this.legend.invalidateSize()},resetAnimation:function(){var a=this.graphs;if(a){var b;for(b=0;b<a.length;b++)a[b].animationPlayed=!1}},animateAgain:function(){this.resetAnimation();this.validateNow()}});
AmCharts.AmSlicedChart=AmCharts.Class({inherits:AmCharts.AmChart,construct:function(a){this.createEvents("rollOverSlice","rollOutSlice","clickSlice","pullOutSlice","pullInSlice","rightClickSlice");AmCharts.AmSlicedChart.base.construct.call(this,a);this.colors="#FF0F00 #FF6600 #FF9E01 #FCD202 #F8FF01 #B0DE09 #04D215 #0D8ECF #0D52D1 #2A0CD0 #8A0CCF #CD0D74 #754DEB #DDDDDD #999999 #333333 #000000 #57032A #CA9726 #990000 #4B0C25".split(" ");this.alpha=1;this.groupPercent=0;this.groupedTitle="Other";this.groupedPulled=
...
b.dataContext));a=c?AmCharts.fixNewLines(a):AmCharts.fixBrakes(a);return AmCharts.cleanFromEmpty(a)},startSlices:function(){var a;for(a=0;a<this.chartData.length;a++)0<this.startDuration&&this.sequencedAnimation?this.setStartTO(a):this.startSlice(this.chartData[a])},setStartTO:function(a){var b=this;a=setTimeout(function(){b.startSequenced.call(b)},b.startDuration/b.chartData.length*500*a);b.timeOuts.push(a)},pullSlices:function(a){var b=this.chartData,c;for(c=0;c<b.length;c++){var d=b[c];d.pulled&&
...
a);var b=this.chartCursor;b&&b.handleMouseDown(a)},handleCursorChange:function(a){}});
AmCharts.TrendLine=AmCharts.Class({construct:function(a){this.cname="TrendLine";this.createEvents("click");this.isProtected=!1;this.dashLength=0;this.lineColor="#00CC00";this.lineThickness=this.lineAlpha=1;AmCharts.applyTheme(this,a,this.cname)},draw:function(){var a=this;a.destroy();var b=a.chart,c=b.container,d,e,f,g,h=a.categoryAxis,k=a.initialDate,l=a.initialCategory,m=a.finalDate,n=a.finalCategory,p=a.valueAxis,t=a.valueAxisX,q=a.initialXValue,r=a.finalXValue,y=a.initialValue,x=a.finalValue,
u=p.recalculateToPercents,w=b.dataDateFormat;h&&(k&&(k instanceof Date||(k=w?AmCharts.stringToDate(k,w):new Date(k)),a.initialDate=k,d=h.dateToCoordinate(k)),l&&(d=h.categoryToCoordinate(l)),m&&(m instanceof Date||(m=w?AmCharts.stringToDate(m,w):new Date(m)),a.finalDate=m,e=h.dateToCoordinate(m)),n&&(e=h.categoryToCoordinate(n)));t&&!u&&(isNaN(q)||(d=t.getCoordinate(q)),isNaN(r)||(e=t.getCoordinate(r)));p&&!u&&(isNaN(y)||(f=p.getCoordinate(y)),isNaN(x)||(g=p.getCoordinate(x)));isNaN(d)||isNaN(e)||
...
AmCharts.rect=function(a,b,c,d,e,f,g,h,k,l,m){isNaN(f)&&(f=0);void 0===k&&(k=0);void 0===l&&(l=270);isNaN(e)&&(e=0);var n=d,p=!1;"object"==typeof n&&(n=n[0],p=!0);void 0===g&&(g=n);void 0===h&&(h=e);b=Math.round(b);c=Math.round(c);var t=0,q=0;0>b&&(b=Math.abs(b),t=-b);0>c&&(c=Math.abs(c),q=-c);t+=AmCharts.dx;q+=AmCharts.dy;e={fill:n,stroke:g,"fill-opacity":e,"stroke-opacity":h};void 0!==m&&0<m&&(e["stroke-dasharray"]=m);a=a.rect(t,q,b,c,k,f).attr(e);p&&a.gradient("linearGradient",d,l);return a};
...
AmCharts.makeHD=function(a,b,c){for(var d=[],e=[],f=1;f<a.length;f++)for(var g=Number(a[f-1]),h=Number(b[f-1]),k=Number(a[f]),l=Number(b[f]),m=Math.sqrt(Math.pow(k-g,2)+Math.pow(l-h,2)),m=Math.round(m/50)+1,k=(k-g)/m,l=(l-h)/m,n=0;n<=m;n++){var p=g+n*k+Math.random()*c,t=h+n*l+Math.random()*c;d.push(p);e.push(t)}return[d,e]};
AmCharts.handDrawnLine=function(a,b,c,d,e,f,g,h,k,l,m){var n=a.set();for(m=1;m<b.length;m++)for(var p=[b[m-1],b[m]],t=[c[m-1],c[m]],t=AmCharts.makeHD(p,t,a.handDrawScatter),p=t[0],t=t[1],q=1;q<p.length;q++)n.push(AmCharts.line(a,[p[q-1],p[q]],[t[q-1],t[q]],d,e,f+Math.random()*a.handDrawThickness-a.handDrawThickness/2,g,h,k,l,!0));return n};AmCharts.doNothing=function(a){return a};
AmCharts.wedge=function(a,b,c,d,e,f,g,h,k,l,m,n){var p=Math.round;f=p(f);g=p(g);h=p(h);var t=p(g/f*h),q=AmCharts.VML,r=359.5+f/100;359.94<r&&(r=359.94);e>=r&&(e=r);var y=1/180*Math.PI,r=b+Math.sin(d*y)*h,x=c-Math.cos(d*y)*t,u=b+Math.sin(d*y)*f,w=c-Math.cos(d*y)*g,z=b+Math.sin((d+e)*y)*f,A=c-Math.cos((d+e)*y)*g,C=b+Math.sin((d+e)*y)*h,y=c-Math.cos((d+e)*y)*t,B={fill:AmCharts.adjustLuminosity(l.fill,-.2),"stroke-opacity":0,"fill-opacity":l["fill-opacity"]},G=0;180<Math.abs(e)&&(G=1);d=a.set();var D;
q&&(r=p(10*r),u=p(10*u),z=p(10*z),C=p(10*C),x=p(10*x),w=p(10*w),A=p(10*A),y=p(10*y),b=p(10*b),k=p(10*k),c=p(10*c),f*=10,g*=10,h*=10,t*=10,1>Math.abs(e)&&1>=Math.abs(z-u)&&1>=Math.abs(A-w)&&(D=!0));e="";var I;n&&(B["fill-opacity"]=0,B["stroke-opacity"]=l["stroke-opacity"]/2,B.stroke=l.stroke);0<k&&(I=" M"+r+","+(x+k)+" L"+u+","+(w+k),q?(D||(I+=" A"+(b-f)+","+(k+c-g)+","+(b+f)+","+(k+c+g)+","+u+","+(w+k)+","+z+","+(A+k)),I+=" L"+C+","+(y+k),0<h&&(D||(I+=" B"+(b-h)+","+(k+c-t)+","+(b+h)+","+(k+c+t)+
","+C+","+(k+y)+","+r+","+(k+x)))):(I+=" A"+f+","+g+",0,"+G+",1,"+z+","+(A+k)+" L"+C+","+(y+k),0<h&&(I+=" A"+h+","+t+",0,"+G+",0,"+r+","+(x+k))),I=a.path(I+" Z",void 0,void 0,"1000,1000").attr(B),d.push(I),I=a.path(" M"+r+","+x+" L"+r+","+(x+k)+" L"+u+","+(w+k)+" L"+u+","+w+" L"+r+","+x+" Z",void 0,void 0,"1000,1000").attr(B),k=a.path(" M"+z+","+A+" L"+z+","+(A+k)+" L"+C+","+(y+k)+" L"+C+","+y+" L"+z+","+A+" Z",void 0,void 0,"1000,1000").attr(B),d.push(I),d.push(k));q?(D||(e=" A"+p(b-f)+","+p(c-g)+
","+p(b+f)+","+p(c+g)+","+p(u)+","+p(w)+","+p(z)+","+p(A)),f=" M"+p(r)+","+p(x)+" L"+p(u)+","+p(w)+e+" L"+p(C)+","+p(y)):f=" M"+r+","+x+" L"+u+","+w+(" A"+f+","+g+",0,"+G+",1,"+z+","+A)+" L"+C+","+y;0<h&&(q?D||(f+=" B"+(b-h)+","+(c-t)+","+(b+h)+","+(c+t)+","+C+","+y+","+r+","+x):f+=" A"+h+","+t+",0,"+G+",0,"+r+","+x);a.handDrawn&&(b=AmCharts.line(a,[r,u],[x,w],l.stroke,l.thickness*Math.random()*a.handDrawThickness,l["stroke-opacity"]),d.push(b));a=a.path(f+" Z",void 0,void 0,"1000,1000").attr(l);
if(m){b=[];for(c=0;c<m.length;c++)b.push(AmCharts.adjustLuminosity(l.fill,m[c]));0<b.length&&a.gradient("linearGradient",b)}a.pattern(n);d.wedge=a;d.push(a);return d};AmCharts.adjustLuminosity=function(a,b){a=String(a).replace(/[^0-9a-f]/gi,"");6>a.length&&(a=String(a[0])+String(a[0])+String(a[1])+String(a[1])+String(a[2])+String(a[2]));b=b||0;var c="#",d,e;for(e=0;3>e;e++)d=parseInt(a.substr(2*e,2),16),d=Math.round(Math.min(Math.max(0,d+d*b),255)).toString(16),c+=("00"+d).substr(d.length);return c};
...
f,.375);b.x+=h;b.y+=k;c=this.getPointOnSegment(d,c,.375);h=this.getMiddle(l,a);f=this.getMiddle(f,g);g=this.getMiddle(b,c);l=" Q"+e(l.x)+","+e(l.y)+","+e(h.x)+","+e(h.y);l+=" Q"+e(a.x)+","+e(a.y)+","+e(f.x)+","+e(f.y);l+=" Q"+e(b.x)+","+e(b.y)+","+e(g.x)+","+e(g.y);return l+(" Q"+e(c.x)+","+e(c.y)+","+e(d.x)+","+e(d.y))},getMiddle:function(a,b){return{x:(a.x+b.x)/2,y:(a.y+b.y)/2}},getPointOnSegment:function(a,b,c){return{x:a.x+(b.x-a.x)*c,y:a.y+(b.y-a.y)*c}}});
...
b),a.setAttribute("angle",d));e&&(a.colors.value=e)},remove:function(a){a.clipPath&&this.D.remove(a.clipPath);this.D.remove(a.node)},disableSelection:function(a){void 0!==typeof a.onselectstart&&(a.onselectstart=function(){return!1});a.style.cursor="default"},pattern:function(a,b){var c=a.node,d=a.fill,e="none";b.color&&(e=b.color);c.fillColor=e;8===document.documentMode?(d.type="tile",d.src=b.url):(d.setAttribute("type","tile"),d.setAttribute("src",b.url))},update:function(){}});
...
AmCharts.AmLegend=AmCharts.Class({construct:function(a){this.enabled=!0;this.cname="AmLegend";this.createEvents("rollOverMarker","rollOverItem","rollOutMarker","rollOutItem","showItem","hideItem","clickMarker","rollOverItem","rollOutItem","clickLabel");this.position="bottom";this.borderColor=this.color="#000000";this.borderAlpha=0;this.markerLabelGap=5;this.verticalGap=10;this.align="left";this.horizontalGap=0;this.spacing=10;this.markerDisabledColor="#AAB3B3";this.markerType="square";this.markerSize=
...
h=this.divWidth,k=this.maxColumns,l=this.verticalGap,m=this.spacing,n=h-c-b,p=0,t=0,q=this.container;this.set&&this.set.remove();var r=q.set();this.set=r;var y=q.set();r.push(y);var x=this.entries,u,w;for(w=0;w<x.length;w++){u=x[w].getBBox();var z=u.width;z>p&&(p=z);u=u.height;u>t&&(t=u)}var z=t=0,A=f,C=0,B=0;for(w=0;w<x.length;w++){var G=x[w];this.reversedOrder&&(G=x[x.length-w-1]);u=G.getBBox();var D;this.equalWidths?D=f+z*(p+m+this.markerLabelGap):(D=A,A=A+u.width+f+m);u.height>B&&(B=u.height);
D+u.width>n&&0<w&&0!==z&&(t++,z=0,D=f,A=D+u.width+f+m,C=C+B+l,B=0);G.translate(D,C);z++;!isNaN(k)&&z>=k&&(z=0,t++,C=C+B+l,B=0);y.push(G)}u=y.getBBox();k=u.height+2*l-1;"left"==a||"right"==a?(h=u.width+2*f,g.style.width=h+b+c+"px"):h=h-b-c-1;c=AmCharts.polygon(this.container,[0,h,h,0],[0,0,k,k],this.backgroundColor,this.backgroundAlpha,1,this.borderColor,this.borderAlpha);AmCharts.setCN(this.chart,c,"legend-bg");r.push(c);r.translate(b,d);c.toBack();b=f;if("top"==a||"bottom"==a||"absolute"==a||"outside"==
a)"center"==this.align?b=f+(h-u.width)/2:"right"==this.align&&(b=f+h-u.width);y.translate(b,l+1);this.titleHeight>k&&(k=this.titleHeight);a=k+d+e+1;0>a&&(a=0);a>this.chart.divRealHeight&&(g.style.top="0px");g.style.height=Math.round(a)+"px";q.setSize(this.divWidth,a)},createEntry:function(a){if(!1!==a.visibleInLegend){var b=this.chart,c=a.markerType;a.legendEntryWidth=this.markerSize;c||(c=this.markerType);var d=a.color,e=a.alpha;a.legendKeyColor&&(d=a.legendKeyColor());a.legendKeyAlpha&&(e=a.legendKeyAlpha());
...
AmCharts.bullet(k,a.bullet,a.bulletSize,d,a.bulletAlpha,a.bulletBorderThickness,f,a.bulletBorderAlpha))&&(AmCharts.setCN(b,m,"graph-bullet"),m.translate(l+1,l/2),g.push(m)),p=0,m=l,n=l/3;else{var t;a.getGradRotation&&(t=a.getGradRotation());m=a.fillColorsR;!0===a.hidden&&(m=d);if(g=this.createMarker("rectangle",m,a.fillAlphas,a.lineThickness,d,a.lineAlpha,t,g))p=l,g.translate(p,l/2);m=l}AmCharts.setCN(b,g,"graph-"+c);AmCharts.setCN(b,g,"graph-"+a.id)}else h?(b.path&&(h=b.path+h),g=k.image(h,0,0,l,
...
h?(g=this.valueText,f.legendValueText&&(g=f.legendValueText),g=b.formatString(g,h)):k&&(g=b.formatPeriodString(k,f))}else g=b.formatString(this.valueText,f);if(k=this.valueFunction)h&&(f=h),g=k(f,g);e.text(g)}}},renderFix:function(){if(!AmCharts.VML){var a=this.container;a&&a.renderFix()}},destroy:function(){this.div.innerHTML="";AmCharts.remove(this.set)}});
AmCharts.formatMilliseconds=function(a,b){if(-1!=a.indexOf("fff")){var c=b.getMilliseconds(),d=String(c);10>c&&(d="00"+c);10<=c&&100>c&&(d="0"+c);a=a.replace(/fff/g,d)}return a};AmCharts.extractPeriod=function(a){var b=AmCharts.stripNumbers(a),c=1;b!=a&&(c=Number(a.slice(0,a.indexOf(b))));return{period:b,count:c}};
...
AmCharts.formatDate=function(a,b,c){c||(c=AmCharts);var d,e,f,g,h,k,l,m=AmCharts.getWeekNumber(a);AmCharts.useUTC?(d=a.getUTCFullYear(),e=a.getUTCMonth(),f=a.getUTCDate(),g=a.getUTCDay(),h=a.getUTCHours(),k=a.getUTCMinutes(),l=a.getUTCSeconds(),a=a.getUTCMilliseconds()):(d=a.getFullYear(),e=a.getMonth(),f=a.getDate(),g=a.getDay(),h=a.getHours(),k=a.getMinutes(),l=a.getSeconds(),a=a.getMilliseconds());var n=String(d).substr(2,2),p=e+1;9>e&&(p="0"+p);var t="0"+g;b=b.replace(/W/g,m);m=h;24==m&&(m=0);
var q=m;10>q&&(q="0"+q);b=b.replace(/JJ/g,q);b=b.replace(/J/g,m);q=h;0===q&&(q=24,-1!=b.indexOf("H")&&f--);m=f;10>f&&(m="0"+f);var r=q;10>r&&(r="0"+r);b=b.replace(/HH/g,r);b=b.replace(/H/g,q);q=h;11<q&&(q-=12);r=q;10>r&&(r="0"+r);b=b.replace(/KK/g,r);b=b.replace(/K/g,q);q=h;0===q&&(q=12);12<q&&(q-=12);r=q;10>r&&(r="0"+r);b=b.replace(/LL/g,r);b=b.replace(/L/g,q);q=k;10>q&&(q="0"+q);b=b.replace(/NN/g,q);b=b.replace(/N/g,k);k=l;10>k&&(k="0"+k);b=b.replace(/SS/g,k);b=b.replace(/S/g,l);l=a;10>l&&(l="00"+
...
b.replace(/@II@/g,n);b=b.replace(/@XXXX@/g,c.monthNames[e]);b=b.replace(/@XXX@/g,c.shortMonthNames[e]);b=b.replace(/@XX@/g,p);b=b.replace(/@X@/g,e+1);b=b.replace(/@RR@/g,m);b=b.replace(/@R@/g,f);b=b.replace(/@PPPP@/g,c.dayNames[g]);b=b.replace(/@PPP@/g,c.shortDayNames[g]);b=b.replace(/@PP@/g,t);return b.replace(/@P@/g,g)};
...
c*f);break;case "mm":a.setUTCMinutes(a.getUTCMinutes()+c*f);break;case "ss":a.setUTCSeconds(a.getUTCSeconds()+c*f);break;case "fff":a.setUTCMilliseconds(a.getUTCMilliseconds()+c*f)}return a};AmCharts.themes.none={};AmCharts.AmRadarChart=AmCharts.Class({inherits:AmCharts.AmCoordinateChart,construct:function(a){this.type="radar";AmCharts.AmRadarChart.base.construct.call(this,a);this.cname="AmRadarChart";this.marginRight=this.marginBottom=this.marginTop=this.marginLeft=0;this.radius="35%";AmCharts.applyTheme(this,a,this.cname)},initChart:function(){AmCharts.AmRadarChart.base.initChart.call(this);this.dataChanged&&(this.updateData(),this.dataChanged=!1,this.dispatchDataUpdated=!0);this.drawChart()},updateData:function(){this.parseData();
...
a=this.chartData;if(AmCharts.ifArray(a)){if(0<this.realWidth&&0<this.realHeight){a=a.length-1;d=this.valueAxes;for(c=0;c<d.length;c++)d[c].zoom(0,a);d=this.graphs;for(c=0;c<d.length;c++)d[c].zoom(0,a);(a=this.legend)&&a.invalidateSize()}}else this.cleanChart();this.dispDUpd();this.chartCreated=!0},formatString:function(a,b,c){var d=b.graph;-1!=a.indexOf("[[category]]")&&(a=a.replace(/\[\[category\]\]/g,String(b.serialDataItem.category)));(d=d.numberFormatter)||(d=this.nf);a=AmCharts.formatValue(a,
b.values,["value"],d,"",this.usePrefixes,this.prefixesOfSmallNumbers,this.prefixesOfBigNumbers);-1!=a.indexOf("[[")&&(a=AmCharts.formatDataContextValue(a,b.dataContext));return AmCharts.AmRadarChart.base.formatString.call(this,a,b,c)},cleanChart:function(){AmCharts.callMethod("destroy",[this.valueAxes,this.graphs])}});
AmCharts.RadAxis=AmCharts.Class({construct:function(a){var b=a.chart,c=a.axisThickness,d=a.axisColor,e=a.axisAlpha,f=a.x,g=a.y;this.set=b.container.set();b.axesSet.push(this.set);var h=a.axisTitleOffset,k=a.radarCategoriesEnabled,l=a.chart.fontFamily,m=a.fontSize;void 0===m&&(m=a.chart.fontSize);var n=a.color;void 0===n&&(n=a.chart.color);if(b){this.axisWidth=a.height;var p=b.chartData,t=p.length,q;for(q=0;q<t;q++){var r=180-360/t*q,y=f+this.axisWidth*Math.sin(r/180*Math.PI),x=g+this.axisWidth*Math.cos(r/
180*Math.PI);0<e&&(y=AmCharts.line(b.container,[f,y],[g,x],d,e,c),this.set.push(y),AmCharts.setCN(b,y,a.bcn+"line"));if(k){var u="start",y=f+(this.axisWidth+h)*Math.sin(r/180*Math.PI),x=g+(this.axisWidth+h)*Math.cos(r/180*Math.PI);if(180==r||0===r)u="middle",y-=5;0>r&&(u="end",y-=10);180==r&&(x-=5);0===r&&(x+=5);r=AmCharts.text(b.container,p[q].category,n,l,m,u);r.translate(y+5,x);this.set.push(r);AmCharts.setCN(b,r,a.bcn+"title");r.getBBox()}}}}});
AmCharts.RadItem=AmCharts.Class({construct:function(a,b,c,d,e,f,g,h){d=a.chart;void 0===c&&(c="");var k=a.chart.fontFamily,l=a.fontSize;void 0===l&&(l=a.chart.fontSize);var m=a.color;void 0===m&&(m=a.chart.color);var n=a.chart.container;this.set=e=n.set();var p=a.axisColor,t=a.axisAlpha,q=a.tickLength,r=a.gridAlpha,y=a.gridThickness,x=a.gridColor,u=a.dashLength,w=a.fillColor,z=a.fillAlpha,A=a.labelsEnabled;f=a.counter;var C=a.inside,B=a.gridType,G,D=a.labelOffset,I;b-=a.height;var N,X=a.x,ka=a.y;
g?(A=!0,void 0!=g.id&&(I=d.classNamePrefix+"-guide-"+g.id),isNaN(g.tickLength)||(q=g.tickLength),void 0!=g.lineColor&&(x=g.lineColor),isNaN(g.lineAlpha)||(r=g.lineAlpha),isNaN(g.dashLength)||(u=g.dashLength),isNaN(g.lineThickness)||(y=g.lineThickness),!0===g.inside&&(C=!0),void 0!==g.boldLabel&&(h=g.boldLabel)):c||(r/=3,q/=2);var P="end",ea=-1;C&&(P="start",ea=1);var Z;A&&(Z=AmCharts.text(n,c,m,k,l,P,h),Z.translate(X+(q+3+D)*ea,b),e.push(Z),AmCharts.setCN(d,Z,a.bcn+"label"),g&&AmCharts.setCN(d,Z,
"guide"),AmCharts.setCN(d,Z,I,!0),this.label=Z,N=AmCharts.line(n,[X,X+q*ea],[b,b],p,t,y),e.push(N),AmCharts.setCN(d,N,a.bcn+"tick"),g&&AmCharts.setCN(d,N,"guide"),AmCharts.setCN(d,N,I,!0));b=Math.round(a.y-b);h=[];k=[];if(0<r){if("polygons"==B){G=a.data.length;for(l=0;l<G;l++)m=180-360/G*l,h.push(b*Math.sin(m/180*Math.PI)),k.push(b*Math.cos(m/180*Math.PI));h.push(h[0]);k.push(k[0]);r=AmCharts.line(n,h,k,x,r,y,u)}else r=AmCharts.circle(n,b,"#FFFFFF",0,y,x,r);r.translate(X,ka);e.push(r);AmCharts.setCN(d,
r,a.bcn+"grid");AmCharts.setCN(d,r,I,!0);g&&AmCharts.setCN(d,r,"guide")}if(1==f&&0<z&&!g&&""!==c){g=a.previousCoord;if("polygons"==B){for(l=G;0<=l;l--)m=180-360/G*l,h.push(g*Math.sin(m/180*Math.PI)),k.push(g*Math.cos(m/180*Math.PI));G=AmCharts.polygon(n,h,k,w,z)}else G=AmCharts.wedge(n,0,0,0,360,b,b,g,0,{fill:w,"fill-opacity":z,stroke:"#000","stroke-opacity":0,"stroke-width":1});e.push(G);G.translate(X,ka);AmCharts.setCN(d,G,a.bcn+"fill");AmCharts.setCN(d,G,I,!0)}!1===a.visible&&(N&&N.hide(),Z&&Z.hide());
""!==c&&(a.counter=0===f?1:0,a.previousCoord=b)},graphics:function(){return this.set},getLabel:function(){return this.label}});
AmCharts.RadarFill=AmCharts.Class({construct:function(a,b,c,d){b-=a.axisWidth;c-=a.axisWidth;var e=Math.max(b,c);b=Math.min(b,c);c=a.chart;var f=c.container,g=d.fillAlpha,h=d.fillColor,e=Math.abs(e-a.y);b=Math.abs(b-a.y);var k=Math.max(e,b);b=Math.min(e,b);var e=k,k=d.angle+90,l=d.toAngle+90;isNaN(k)&&(k=0);isNaN(l)&&(l=360);this.set=f.set();void 0===h&&(h="#000000");isNaN(g)&&(g=0);if("polygons"==a.gridType){var l=[],m=[],n=a.data.length,p;for(p=0;p<n;p++)k=180-360/n*p,l.push(e*Math.sin(k/180*Math.PI)),
m.push(e*Math.cos(k/180*Math.PI));l.push(l[0]);m.push(m[0]);for(p=n;0<=p;p--)k=180-360/n*p,l.push(b*Math.sin(k/180*Math.PI)),m.push(b*Math.cos(k/180*Math.PI));f=AmCharts.polygon(f,l,m,h,g)}else f=AmCharts.wedge(f,0,0,k,l-k,e,e,b,0,{fill:h,"fill-opacity":g,stroke:"#000","stroke-opacity":0,"stroke-width":1});AmCharts.setCN(c,f,"guide-fill");d.id&&AmCharts.setCN(c,f,"guide-fill-"+d.id);this.set.push(f);f.translate(a.x,a.y);this.fill=f},graphics:function(){return this.set},getLabel:function(){}});function initializeSkills(){AmCharts.makeChart("keyskills",{type:"radar",theme:"none",dataProvider:[{skillname:"HTML 5",skillpercent:80},{skillname:"CSS 3",skillpercent:80},{skillname:"JavasScript and JQuery",skillpercent:80},{skillname:"AngularJS",skillpercent:80},{skillname:"Java SE-EE",skillpercent:100},{skillname:"Hibernate 3",skillpercent:100},{skillname:"JPA 2",skillpercent:90},{skillname:"EJB 3",skillpercent:50},{skillname:"Spring 3",skillpercent:100},{skillname:"Struts (1.2.9)",skillpercent:100},
{skillname:"Spring MVC",skillpercent:100},{skillname:"JSF (1.1, 1.2, 2)",skillpercent:100},{skillname:"Servlet 2.2",skillpercent:100},{skillname:"CXF Web Services",skillpercent:70},{skillname:"Primefaces (3.5, 4)",skillpercent:100},{skillname:"GlassFish",skillpercent:80},{skillname:"WebSphere",skillpercent:80},{skillname:"Apache Tomcat",skillpercent:100},{skillname:"JBoss AS7",skillpercent:80},{skillname:"Eclipse Dev and  API",skillpercent:100},{skillname:"PostgresSQL",skillpercent:70},{skillname:"Oracle",
skillpercent:30},{skillname:"Hudson, Jenkins",skillpercent:100},{skillname:"Ant, Maven",skillpercent:100},{skillname:"CVS, SVN, GIT",skillpercent:100},{skillname:"SonarQube (PMD, Checkstyle)",skillpercent:90},{skillname:"Selenium IDE",skillpercent:80}],colors:["#5cb85c"],valueAxes:[{axisTitleOffset:20,minimum:0,maximum:100,axisAlpha:.15,fillColor:"#357ebd",fillAlpha:"0.05"}],startDuration:0,graphs:[{balloonText:"[[category]] : <b>[[value]] %</b>",bullet:"round",valueField:"skillpercent",legendValueText:"APPPPPPPPPPPPPp"}],
categoryField:"skillname",exportConfig:{menuTop:"10px",menuRight:"10px",menuItems:[{icon:"/lib/3/images/exportskills.png",format:"png"}]}})};